...
<body>
    ...
    <div class="text-center py-4 bg-info">
        ...
        <div class="container" id="add-note-container">
            <form id="add-note-form">
                <div class="form-group m-auto w-50 p-3">
                    <textarea class="form-control" id="note-text" placeholder="Write your note here..."></textarea>
                    <button class="btn btn-success my-3" type="button" id="add-note-btn">Add Note</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content bg-info">
                ...
                <div class="modal-body mx-3">
                    <form id="loginForm" method="POST" action="./../LOGIN/login_process.php">
